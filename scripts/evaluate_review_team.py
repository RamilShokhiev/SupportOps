...
def markdown(report):
    ...
    lines += [
        ...
        'Per-ticket results and exact code hashes for this run: '
        '[dev_review_team.json](../data/evaluation/dev_review_team.json). '
        'The existing baseline reports and predictions are preserved.', '',
    ]
    return '\n'.join(lines)
